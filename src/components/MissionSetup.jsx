...
async function resolvePlace(text){
  ...
  try{return await geocodePlace(text)}catch(e){throw new Error(e?.message||'Place lookup is unavailable. Enter latitude and longitude directly.')}
}
...
export default function MissionSetup({initial,gps,gpsError,onStart}){
  ...
  return <div className="setup-page">
    ...
    </div><div className="small-note">The UTC offset matters because the natal Ascendant and houses depend on the exact birth time at the birth location. Place lookup uses OpenStreetMap/Nominatim (© OpenStreetMap contributors). You can always enter latitude and longitude directly.</div></section>
